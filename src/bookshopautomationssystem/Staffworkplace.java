 ...
 * @author atul
 */
public class Staffworkplace extends javax.swing.JFrame {
    

    /**
     * Creates new form Staffworkplace
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Staffworkplace.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
