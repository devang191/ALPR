...
public class ShowStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        staffQuery = java.beans.Beans.isDesignTime() ? null : bookdbPUEntityManager.createQuery("SELECT s FROM Staff s");
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${staffcontactnumber}"));
        columnBinding.setColumnName("Staffcontactnumber");
        columnBinding.setColumnClass(String.class);
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${staffsalary}"));
        columnBinding.setColumnName("Staffsalary");
        columnBinding.setColumnClass(String.class);
    ...
    private java.util.List<bookshopautomationssystem.Staff> staffList;
