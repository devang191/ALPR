...
public class ShowStudents extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        studentsQuery = java.beans.Beans.isDesignTime() ? null : bookdbPUEntityManager.createQuery("SELECT s FROM Students s");
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${studentclass}"));
        columnBinding.setColumnName("Studentclass");
        columnBinding.setColumnClass(String.class);
    ...
    private java.util.List<bookshopautomationssystem.Students> studentsList;
